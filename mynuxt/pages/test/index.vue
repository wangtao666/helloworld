...
//      },
      loadBottom:function() {
        ...
        setTimeout(function () {
          document.getElementsByClassName('mint-loadmore-bottom')[0].childNodes[2].innerText = '上拉加载更多'
      ...
      isHaveMore:function(isHaveMore){
        ...
        if (isHaveMore) {
          ...
          setTimeout(function () {
            document.getElementsByClassName('mint-loadmore-bottom')[0].childNodes[2].innerText = '加载完成'
            document.getElementsByClassName('mint-loadmore-bottom')[0].style.marginBottom = '0px'
          },200)
        }
      }
...
<style>
  .mint-loadmore-content {
    ...
    /*transition: transform 0.4s cubic-bezier(.07,-0.47,.36,1.83);*/
  }
</style>
